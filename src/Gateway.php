...
use Corals\Modules\Payment\Stripe\Message\FetchConnectAccountRequest;
...
class Gateway extends AbstractGateway
{
    ...
    public function getApiConnectClientId()
    {
        return $this->getParameter('apiConnectClientId');
    }
    ...
    public function setApiConnectClientId($value)
    {
        return $this->setParameter('apiConnectClientId', $value);
    }
    ...
    public function setAuthentication()
    {
        ...
        if ($sandbox == 'true') {
            ...
            $connect_client_id = \Settings::get('payment_stripe_sandbox_connect_client_id');
            ...
            $connect_client_id = \Settings::get('payment_stripe_live_connect_client_id');
        }

        $this->setApiKey($secret_key);
        $this->setApiPublicKey($public_key);
        $this->setApiWebhookKey($webhook_key);
        $this->setApiConnectClientId($connect_client_id);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Stripe\Message\FetchBalanceTransactionRequest',
            $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Stripe\Message\Transfers\CreateTransferRequest',
            $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Stripe\Message\Transfers\FetchTransferRequest',
            $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Stripe\Message\Transfers\UpdateTransferRequest',
            $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Stripe\Message\Transfers\ListTransfersRequest',
            $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Stripe\Message\Transfers\CreateTransferReversalRequest',
            $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Stripe\Message\Transfers\FetchTransferReversalRequest',
            $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Stripe\Message\Transfers\UpdateTransferReversalRequest',
            $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Stripe\Message\Transfers\ListTransferReversalsRequest',
            $parameters);
    }
    ...
    {
        return $this->createRequest('\Corals\Modules\Payment\Stripe\Message\CapturePaymentIntentRequest', $parameters);
    }
    ...
    public function preparePlanParameters(Plan $plan)
    {
        return [
            ...
            'statement_descriptor' => \Str::limit($plan->description, 19),
            'name' => $plan->name,
    ...
    public function prepareCreateChargeParameters($order, User $user, $checkoutDetails)
    {
        return [
            ...
            'paymentIntentReference' => $checkoutDetails['token'],
    ...
    public function prepareCreateMultiOrderChargeParameters($orders, User $user, $checkoutDetails)
    {
        ...
        return [
            ...
            'statement_descriptor' => \Str::limit($description, 19),
        ];
    }
    ...
    public function getPaymentViewName($type = null)
    {
        switch ($type) {
            case 'subscription':
                ...
                break;
            case 'reservation':
                $view = 'Stripe::reservation';
                break;
            case "marketplace":
                $view = 'Stripe::marketplace';
                break;
            default:
                $view = 'Stripe::ecommerce';
        }
    ...
    {
        return view("Stripe::scripts")->render();
    }

    public function getConnectAccountAuthorizeURL()
    {
        $params = array(
            'response_type' => 'code',
            'scope' => 'read_write',
            'client_id' => $this->getApiConnectClientId(),
            'redirect_uri' => url('stripe/authorize-connect')
        );

        $authorize_url = 'https://dashboard.stripe.com/express/oauth/authorize';

        return $authorize_url . '?' . http_build_query($params);
    }

    public function fetchConnectAccount($parameters = [])
    {
        return $this->createRequest(FetchConnectAccountRequest::class, $parameters);
    }
}
