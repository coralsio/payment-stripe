...
class InstallModuleServiceProvider extends BaseInstallModuleServiceProvider
{
    protected function providerBooted()
    {
        ...
        \DB::table('settings')->insert([
            ...
            [
                'code' => 'payment_stripe_connect_enabled',
                'type' => 'TEXT',
                'category' => 'Payment',
                'label' => 'payment_stripe_connect_enabled',
                'value' => 'true',
                'editable' => 1,
                'hidden' => 1,
                'created_at' => Carbon::now(),
            ...
            [
                'code' => 'payment_stripe_sandbox_connect_client_id',
                'type' => 'TEXT',
                'category' => 'Payment',
                'label' => 'payment_stripe_sandbox_connect_client_id',
                'value' => 'ca_Ix4uzaWJgQOFFUeTv2cpIRzte8pGv4wZ',
                'editable' => 1,
                'hidden' => 1,
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
