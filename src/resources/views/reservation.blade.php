            ...
            $('#payment-form').on('submit', function (event) {
                ...
                stripe.createPaymentMethod(
                    ...
                    if (result.error) {
                        ...
                        fetch('{{url('reservation/checkout/gateway-payment-token/'.$gateway->getName().'/'.$reservation->hashed_id) }}?payment_method_id=' + result.paymentMethod.id, {
                            method: 'GET',
                            headers: {
            ...
            function handleAction(response) {
                ...
                stripe.handleCardAction(
                    ...
                    if (result.error) {
                        ...
                        blockUI($('#payment-form'));
                        fetch('{{url('reservation/checkout/gateway-check-payment-token/'.$gateway->getName()) }}?payment_intent_id=' + response.payment_intent_id, {
                            method: 'GET',
                            headers: {
                                'Content-Type': 'application/json',
                                'Data-Type': 'json',
